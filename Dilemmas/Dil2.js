    ...
    constructor() {
      super({ key: 'Dil2'})
       ...
       create(){
        ...
        keuze1Text = this.add.text(205, 570, 'Tell your boss\nto go f*ck himself', {fontSize: '25px', color: '0x000000', fontFamily: 'VT323'}).setDepth(0.1)
        
        keuze2Text = this.add.text(575, 550, `Tell him you're happy\nto do it.\nThen make someone else\ndo it`, {fontSize: '23px', color: '0x000000', fontFamily: 'VT323'}).setDepth(0.1)
