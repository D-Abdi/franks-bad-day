const config = {
    ...
    scene: [Preload, Title, Disc, Intro, MG1, Dil1, Scene3, MG2, Dil2, Scene4, MG3, Dil3, Scene5_1, Dil4, Scene5_2, MG4, Dil5, Dil5_Good, Dil5_Bad, Good, Bad, Limbo, Coward, Credits],
    scale: {
